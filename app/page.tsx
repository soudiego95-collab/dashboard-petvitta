        ...
        <div className="mx-auto max-w-[1540px] px-5 py-7 sm:px-8 lg:px-10 lg:py-9">
          ...
          {isFiltering ? (
            ...
            <>
              ...
              {page === 'Filiais' && <Branches selectedBranch={selectedBranch} setSelectedBranch={setSelectedBranch} filteredBranches={filteredBranches} filteredMonths={filteredMonths} isSingleBranch={isSingleBranch} avgMarginAll={avgMarginAll} />}
